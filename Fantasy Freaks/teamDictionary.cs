...
namespace Fantasy_Freaks
{
    class teamDictionary
    {
        ...
        public Dictionary<string, string> bannerSeason = new Dictionary<string, string>()
        {
            ...
            {"New York Giants", "Properties.Resources.Gaints" },
            ...
            {"San Francisco 49ers", "Properties.Resources.49ers" },
            {"Seattle Seahawks", "Properties.Resources.Seahawks" },
            {"Tampa Bay Buccaneers", "Properties.Resources.Buccaneers" },
        ...
        public Dictionary<string, string> labelSeason = new Dictionary<string, string>()
        {
            ...
            {"Kansas City Chiefs", "Color.FromArgb(277,24,55)" },
